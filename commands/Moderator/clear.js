module.exports = {
    name : 'clear',
    aliases  : ['purge'],
    description : "پیام های داخل تکست چنل را به تعدادی که بخواهید پاک میکنه",
    run : async(client , message , args) => {
        ...
        message.channel.send(`** ${args[0]} Message Deleted <a:727631189992669224:838454115830857761> **`).then(m => m.delete({ timeout : 5000 }))
